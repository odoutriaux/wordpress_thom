			...
			<div class="header-content">
				<div class="links">
					<ul>
						...
						<li <?php if (isset($GLOBALS['page-selected']) && $GLOBALS['page']=="contact") echo "class=\"selected\""?>><a href="<?php echo get_permalink(get_page_by_title('Contact')->ID) ?>">Contact</a></li>
					</ul>
				</div>